...
public class MediaFragment extends CommonListFragment<MainMenu> {
    ...
    private String[] names = new String[]{"测试1 相机Camera1使用","测试2 音视频的采集、编码、封包成 mp4 输出","测试3 音频播放"};
    private Class<?>[] clazzs = new Class[]{Camera1DemoActivity.class,MediaRecordActivity.class, MediaPlayActivity.class};
